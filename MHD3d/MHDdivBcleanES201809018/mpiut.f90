...
!  integer :: recvcount = (NY+2)*(NZ+1)*8
  real(DP), dimension(0:NZ,-1:NY,9) :: sendbuf, recvbuf
  integer :: sendcount = (NY+2)*(NZ+1)*9
  integer :: recvcount = (NY+2)*(NZ+1)*9
  integer, dimension(MPI_STATUS_SIZE) :: status 
...
!  integer :: recvcount = (NX+2)*(NZ+1)*8
  real(DP), dimension(0:NZ,-1:NX,9) :: sendbuf, recvbuf
  integer :: sendcount = (NX+2)*(NZ+1)*9
  integer :: recvcount = (NX+2)*(NZ+1)*9
  integer, dimension(MPI_STATUS_SIZE) :: status 
...
! -----------------------------------------------------------
subroutine mpiut__exchange_phi_x
...
return
end subroutine mpiut__exchange_phi_x
! -----------------------------------------------------------
subroutine mpiut__exchange_phi_y
...
return
end subroutine mpiut__exchange_phi_y
! -----------------------------------------------------------
end module mpiut
