...
!  character*100 :: dirname_ini="../../../../../../make_shearedfield/data/relax_20171102/sh17_newbztf250/"
  character*100 :: dirname_ini="../../../sh1_0822_peq0/"
...
!
ts = tsini
   call make_merge_file_8x8(ts,dirname_ini,filere)

do ts = tsbeg1, tsfin1
   call make_merge_file_8x8(ts,dirname1,fileb3d)
enddo
!
! do ts = tsbeg2, tsfin2
...
ts = ts_re
   call make_merge_file_8x8(ts,dirname1,filere)
!-----------
!-----------
  !--- y dim
  ...
  !    yc(i+ny) = yc0(i)
  ! enddo
  open(40,file=trim(dirname1)//"COORDINATE_y.0000", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') yc0
  close(40)
  do i = 0, ny
     yc(i) = yc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_y.0001", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') yc0
  close(40)
  do i = 0, ny
     yc(i+ny) = yc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_y.0002", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') yc0
  close(40)
  do i = 0, ny
     yc(i+ny*2) = yc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_y.0003", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') yc0
  close(40)
  do i = 0, ny
     yc(i+ny*3) = yc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_y.0004", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') yc0
  close(40)
  do i = 0, ny
     yc(i+ny*4) = yc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_y.0005", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') yc0
  close(40)
  do i = 0, ny
     yc(i+ny*5) = yc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_y.0006", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') yc0
  close(40)
  do i = 0, ny
     yc(i+ny*6) = yc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_y.0007", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') yc0
  close(40)
  do i = 0, ny
  ...
  !--- x dim
  open(40,file=trim(dirname1)//"COORDINATE_x.0000", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') xc0
  close(40)
  do i = 0, nx
     xc(i) = xc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_x.0008", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') xc0
  close(40)
  do i = 0, nx
     xc(i+nx) = xc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_x.0016", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') xc0
  close(40)
  do i = 0, nx
     xc(i+2*nx) = xc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_x.0024", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') xc0
  close(40)
  do i = 0, nx
     xc(i+3*nx) = xc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_x.0032", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') xc0
  close(40)
  do i = 0, nx
     xc(i+4*nx) = xc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_x.0040", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') xc0
  close(40)
  do i = 0, nx
     xc(i+5*nx) = xc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_x.0048", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') xc0
  close(40)
  do i = 0, nx
     xc(i+6*nx) = xc0(i)
  enddo
  open(40,file=trim(dirname1)//"COORDINATE_x.0056", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') xc0
  close(40)
  do i = 0, nx
  ...
  !--- z dim
  open(40,file=trim(dirname1)//"COORDINATE_z.0000", status="old")
  read(40,*) forread(1), forread(2), forread(3), forread(4), forread(5)
  read(40,'(e25.16)') zc
  close(40)
  !--- output coordinate
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
contains
subroutine make_merge_file_8x8(sub_ts,sub_dirname,sub_fname)
...
!-----------
  ...
  if(trim(sub_fname).eq."B3D+") then
     open(10,file=trim(sub_dirname)//trim(sub_fname)//chr_timestep//"."//chr_process_number, form="unformatted", status="old")
