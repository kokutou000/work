...
integer,parameter :: NX=448
integer,parameter :: NY=448
integer,parameter :: NZ=205
integer,parameter :: nx0=NX*0.0, nx1=NX*1.0
integer,parameter :: ny0=NY*0.0, ny1=NY*1.0
integer,parameter :: nz0=0, nz1=NZ*1.0
integer,parameter :: leapx=1
integer,parameter :: leapy=1
integer,parameter :: leapz=1
!.............................................................
integer,parameter :: nxl=(nx1-nx0)/leapx, &
                     nyl=(ny1-ny0)/leapy, &
                     nzl=(nz1-nz0)/leapz
